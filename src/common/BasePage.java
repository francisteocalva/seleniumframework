...
public abstract class BasePage {
	 ...
	 * @param value
	 *
	 * @author lenard.g.magpantay element.submit();
	 * 
	 */
	...
	/*
	public void Sales () {
		 WebElement ele = driver.findElement(By.id("menu-item-26"));
		 Actions action = new Actions(driver);
	...
	*/
	...
	/**
	 * This method will verify if the element is displayed (with waiting
	 * command)
	 * 
	 * @param locator
	 * @param locType
